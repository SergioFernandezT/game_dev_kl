...
class Explosion:
    def __init__(self):
        self.images = [ r"crazy-copter\boom1.png", r'crazy-copter\boom2.png',
                        r'crazy-copter\bigboom.png']
        self.boom = []
...
class Building:
    def __init__ (self, x, size):
        self.x = x
        self.size = size
        self.image1 = pygame.image.load(r'crazy-copter\build1.jpg')
        self.image2 = pygame.image.load(r'crazy-copter\build2.jpg')
...
class Bomb:
    def __init__ (self, x, y, yspeed):
        ...
        self.y = y
        self.yspeed = yspeed
        self.image = pygame.image.load(r'crazy-copter\bomb.png')
...
class Cloud(object):
    def __init__ (self, x,y, xspeed):
        ...
        self.y = y
        self.xspeed = xspeed
        self.image = pygame.image.load('crazy-copter\cloud.png')
        self.width = self.image.get_width()
        self.height = self.image.get_height()
...
class Sun(Cloud):
    def __init__(self, x,y, xspeed):
        ...
        self.image = pygame.image.load('crazy-copter\sun.png')
        self.width = self.image.get_width()
        self.height = self.image.get_height()
...
class Copter:
    def __init__ (self, x, y, xspeed, yspeed):
        ...
        self.withbomb = False
        self.angle = 0
        self.image = pygame.image.load('crazy-copter\copter.png')
        self.image2 = pygame.image.load('crazy-copter\copter2.png')
        self.width = self.image.get_width()
        self.height = self.image.get_height()
...
def RestartGame(level):
    ...
    for i in range(0,8):
      ...
      x = x + 70
    PlayBackgroundSound("crazy-copter\helicopter.wav")
...
framerate=60
space = 0
explosion = PrepareSound("crazy-copter\explosion.wav")
