...
def main():
    ...
    laser = PrepareSound('pygame-invaders\shoot.wav')
    explosion = PrepareSound("pygame-invaders\invaderkilled.wav")
    destroyed = PrepareSound("pygame-invaders\explosion.wav")

    # Initialize the background and spaceship objects

    spaceship_low = (0,0)
    spaceship_high = (screenwidth, screenheight)
    StarField = SpaceBackground(screenheight, "pygame-invaders\stars.jpg")
    shipimages = ('pygame-invaders\spaceship2.png', 'pygame-invaders\spaceship3.png')
    ...
    PlayMusic("pygame-invaders\spaceinvaders.ogg")

    # Images used for the aliens

    alienimage=(r'pygame-invaders\alien1.png',r'pygame-invaders\alien2.png',r'pygame-invaders\alien3.png',
                r'pygame-invaders\alien4.png',r'pygame-invaders\alien5.png')
